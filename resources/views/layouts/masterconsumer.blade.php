      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class=" "style="background-color:white">
            ...
            <form method="post" action="/accountnocatch" style="background-color:white">
              
              
            <div class="text-center"> <input type="search" class="form-control" name="q" placeholder="Enter Your Account Number ">
              <button type="submit" class="btn btn-success text-center">Search </button></div>    
                </form>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p><a class="navbar-brand" href="/home">Home</a></p>
            <br>
            
            <p align:"center"><a class="navbar-brand">Account No</a></p><br> 
