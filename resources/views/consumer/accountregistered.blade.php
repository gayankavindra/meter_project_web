   ...
   <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <a href="/account-add" class="btn btn-info float-right"><i class="now-ui-icons ui-1_simple-add">&nbsp Add new Account</i></a>  
             <br>
              ...
              <table class="table table-dark">
               ...
               @foreach($account_information as $ar)
                ...
                <a href="/account-edit/{{$ar->id}}" class="btn btn-warning text-center"><i class="now-ui-icons design-2_ruler-pencil"></i>&nbsp Edit</a>
